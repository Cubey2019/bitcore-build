 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`vertcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`vertcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'vertcore-' + name : 'vertcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/vertcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external vertcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:vertcore-lib -o vertcore-lib.js';
    }
